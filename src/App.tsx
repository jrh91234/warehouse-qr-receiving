...
export default function App(){
  ...
  async function logout(){
    ...
    sessionStorage.removeItem(KEY+'-session');sessionStorage.removeItem(KEY+'-user');setSessionToken('');setUser(null);setView('scan');setRawQR('');setEditingRecord(null);setHistoryRecords([]);setHistoryLoaded(false);setHistoryDate('');setHistoryEmployee('');setNotice(null);
  }
  ...
  const filteredHistory=historyItems.filter(item=>(!historyDate||dateKey(item.createdAt)===historyDate)&&(!historyEmployee||item.employee===historyEmployee));
