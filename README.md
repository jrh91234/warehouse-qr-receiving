...
5. ตรวจรหัสพาร์ท ล็อต คลัง ตำแหน่ง จำนวนจริง และหน่วย แล้วกดยืนยันรับเข้า ชื่อ/รหัสผู้รับจะใช้ username ที่ Login โดยอัตโนมัติ
6. สถานะ **บันทึกแล้ว** หมายถึงเซิร์ฟเวอร์ยืนยันแล้ว หากเน็ตหลุดให้เปิดประวัติและกด **ส่งรายการรอ**
