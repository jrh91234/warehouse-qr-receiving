...
6. สถานะ **บันทึกแล้ว** หมายถึงเซิร์ฟเวอร์ยืนยันแล้ว หากเน็ตหลุดให้เปิดประวัติและกด **ส่งรายการรอ** รายการของตนเองลบได้จากรายการล่าสุด/ประวัติ ส่วน Admin ลบรายการของทุกคนได้
...
QR เดียวกันรับเข้าได้ครั้งเดียว ทั้งในเครื่องและบนเซิร์ฟเวอร์ จึงเหมาะกับป้ายที่มีรหัสเฉพาะถุง/กล่อง หากเป็น QR รหัสพาร์ทที่ใช้ซ้ำ ต้องปรับกติกาก่อนใช้จริง จำนวนแก้ได้ก่อนบันทึก รายการที่ส่งแล้วลบได้โดยเจ้าของรายการหรือ Admin ผ่านหน้าเว็บ
