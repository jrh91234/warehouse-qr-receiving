...
ป้าย Warehouse แบบในรูปใช้รูปแบบ `MaterialCode*LotNumber*PackageReference` เช่น `1005QT00197*2026083001*0002-2` แอปจะแยก Material code และ Lot number ให้ และตั้ง Quantity เป็น 1 EA ตามป้าย ตัวเลขท้ายใช้ตรวจสอบอ้างอิงแพ็กเกจและเก็บซ้ำใน Raw QR
